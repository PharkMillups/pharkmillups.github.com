...
Distributed systems aren't limited to the world of computing. Companies and communities, for example, are also distributed networks of resources. This talk is a high-level look at computers, companies, and communities as distributed systems with a focus on why maintaining their health is crucial if they are to scale. (PDF version of the slides are "here":fix_path_)
